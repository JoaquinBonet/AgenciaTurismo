...
public class UsuariosDAOImpl implements UsuariosDAO {
	...
	public int insert(Usuario usuario) {
		try {
			String sql = "INSERT INTO USUARIO (nombre, id_tipo_atraccion, tiempo, presupuesto, is_admin) VALUES (?, ?, ?, ?, ?)";
	...
	public int update(Usuario usuario) {
		try {
			String sql = "UPDATE USUARIO SET tiempo = ?, presupuesto = ?, id_tipo_atraccion = ? WHERE nombre = ?";
			Connection conn = ConnectionProvider.getConnection();
			...
			statement.setInt(3, usuario.getIdTipoAtraccion());
	...
	public Usuario toUser(ResultSet resultados) throws Exception {
		...
		return new Usuario(resultados.getString(2), resultados.getString(8), 
				resultados.getDouble(4), resultados.getInt(5), resultados.getBoolean(6));
